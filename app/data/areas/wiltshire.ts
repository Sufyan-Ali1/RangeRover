...
export const wiltshireArea:Area = {
  id: "wiltshire",
  slug: "wiltshire",
  title: "Wiltshire",
  meta: {
  ...
  headerData: {
    ...
    highlights: [
      ...
      "Collection from Wiltshire, fitted at our workshop",
  ...
  reviews: [
    {
      id: 1,
      name: "Frederick Amescott",
      date: "3 weeks ago",
      text: '"Arranged collection from Swindon for a reconditioned engine on my Range Rover Sport. Kept me informed at every stage and the fitted engine runs beautifully."',
      stars: 5,
    },
    {
      id: 2,
      ...
      date: "1 month ago",
      text: '"Was unsure about the distance from Salisbury, but collection was arranged quickly and the whole process felt easy to follow."',
      stars: 5,
    },
    {
      id: 3,
      name: "Lucas Ferriman",
      date: "5 weeks ago",
      text: '"Booked engine diagnostics after my Vogue started losing power on the M4. Diagnosis was accurate and the recommended repair matched exactly what it needed."',
      stars: 5,
    },
    {
      id: 4,
      name: "Octavia Marchmont",
      date: "2 months ago",
      text: '"Head gasket failure on my Evoque meant I needed a specialist that could collect from Wiltshire. Straightforward process with honest pricing throughout."',
      stars: 5,
    },
    {
      id: 5,
  ...
  overview: [
    {
      overviewHeading:
        "Reconditioned Range Rover Engines Supplied & Fitted For Wiltshire",
      fullOverviewParagraphs: [
        "Wiltshire drivers don't need a local Range Rover specialist nearby to get proper engine work done. We arrange collection from across the county, carry out the reconditioning or supply-and-fit work at our workshop, then return your vehicle running properly with the whole process managed from start to finish.",
        "Every reconditioned engine we supply is matched precisely to your model and fitted using genuine OEM parts. Drivers around Swindon and Salisbury get the same specialist attention as customers who visit us directly, backed by clear delivery timescales and honest pricing throughout.",
      ],
    },
  ],
  technicalContent: [
  ...
  premiumServices: [
    {
      ...
      paragraphs: [
        "We source a reconditioned engine matched to your Range Rover's exact model, then arrange collection from Wiltshire for fitting at our workshop.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Your vehicle is collected from Wiltshire and returned once complete.",
      ],
  ...
  engineServicesMain: {
    heading: "Complete Engine & Drivetrain Support For Wiltshire Owners",
    intro:
      "From timing components to a full engine replacement, we handle the essential work Range Rover and Land Rover engines actually need, with collection arranged from across Wiltshire.",
    viewMoreHref: "/services",
  },
  specialistData: {
    heading: "Trusted Beyond Our Own Workshop Doors",
    paragraphs: [
      "Distance from our workshop shouldn't stand between Wiltshire drivers and proper specialist engine work. We arrange collection and delivery so the process feels just as straightforward as booking locally, with the same manufacturer-approved procedures and genuine OEM parts used on every job. Clear timescales, transparent pricing, and honest communication mean you always know where your vehicle is in the process, whether it's still on collection or already back on the road.",
    ],
    mainBullets: [
      "Collection and delivery arranged across Wiltshire",
    ...
    sidePanel: {
      ...
      bullets: [
        "Collection arranged directly from your Wiltshire address",
