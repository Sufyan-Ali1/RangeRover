...
export const rutlandArea: Area = {
  ...
  headerData: {
    ...
    highlights: [
      ...
      "Collection from Rutland, fitted at our workshop",
  ...
  reviews: [
    {
      ...
      date: "3 weeks ago",
      text: '"Arranged collection from Oakham for a reconditioned engine on my Range Rover Sport. Kept me updated at every stage and the fitted engine runs beautifully."',
      stars: 5,
    },
    {
      id: 2,
      name: "Henrietta Vane",
      date: "1 month ago",
      text: '"Was unsure about the distance from Uppingham, but collection was arranged quickly and the whole process felt easy to follow."',
      stars: 5,
    },
    {
      id: 3,
      name: "Aubrey Manderville",
      date: "5 weeks ago",
      text: '"Booked engine diagnostics after my Evoque started losing power on the A1. Diagnosis was accurate and the recommended repair matched exactly what it needed."',
      stars: 5,
    },
    {
      id: 4,
      name: "Chiamaka Obi",
      date: "2 months ago",
      text: '"Head gasket failure on my Vogue meant I needed a specialist that could collect from Rutland. Straightforward process with honest pricing throughout."',
      stars: 5,
    },
    {
      id: 5,
      name: "Leopold Ashcombe",
      date: "6 weeks ago",
  ...
  overview: [
    {
      overviewHeading:
        "Reconditioned Range Rover Engines Supplied & Fitted For Rutland",
      fullOverviewParagraphs: [
        "Rutland drivers don't need a local Range Rover specialist nearby to get proper engine work done. We arrange collection from across the county, carry out the reconditioning or supply-and-fit work at our workshop, then return your vehicle running properly with the whole process managed from start to finish.",
        "Every reconditioned engine we supply is matched precisely to your model and fitted using genuine OEM parts. Drivers around Oakham and Uppingham get the same specialist attention as customers who visit us directly, backed by clear delivery timescales and honest pricing throughout.",
      ],
    },
  ],
  technicalContent: [
  ...
  premiumServices: [
    {
      ...
      paragraphs: [
        "We source a reconditioned engine matched to your Range Rover's exact model, then arrange collection from Rutland for fitting at our workshop.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Your vehicle is collected from Rutland and returned once complete.",
      ],
  ...
  engineServicesMain: {
    heading: "Complete Engine & Drivetrain Support For Rutland Owners",
    intro:
      "From timing components to a full engine replacement, we handle the essential work Range Rover and Land Rover engines actually need, with collection arranged from across Rutland.",
    viewMoreHref: "/services",
  },
  specialistData: {
    heading: "Trusted Beyond Our Own Workshop Doors",
    paragraphs: [
      "Distance from our workshop shouldn't stand between Rutland drivers and proper specialist engine work. We arrange collection and delivery so the process feels just as straightforward as booking locally, with the same manufacturer-approved procedures and genuine OEM parts used on every job. Clear timescales, transparent pricing, and honest communication mean you always know where your vehicle is in the process, whether it's still on collection or already back on the road.",
    ],
    mainBullets: [
      "Collection and delivery arranged across Rutland",
    ...
    sidePanel: {
      ...
      bullets: [
        "Collection arranged directly from your Rutland address",
