...
export const norfolkArea:Area = {
  ...
  headerData: {
    ...
    highlights: [
      ...
      "Collection from Norfolk, fitted at our workshop",
  ...
  reviews: [
    {
      id: 1,
      name: "Sebastian Coote",
      date: "3 weeks ago",
      text: '"Arranged collection from Norwich for a reconditioned engine on my Range Rover Vogue. Kept me informed at every stage and the fitted engine runs faultlessly."',
      stars: 5,
    },
    {
      id: 2,
      name: "Millie Dunkerton",
      date: "1 month ago",
      text: '"Was unsure about the distance from Great Yarmouth, but collection was sorted quickly and the whole process felt easy to follow."',
      stars: 5,
    },
    {
      id: 3,
      name: "Reuben Ashcroft",
      date: "5 weeks ago",
      text: '"Booked engine diagnostics after my Discovery started losing power on the motorway. Diagnosis was spot on and the repair matched exactly what was needed."',
      stars: 5,
    },
    {
      id: 4,
      name: "Lauren Pettit",
      date: "2 months ago",
      text: '"Head gasket failure on my Sport meant I needed a specialist that could collect from Norfolk. Straightforward process with honest pricing throughout."',
      stars: 5,
    },
    {
      id: 5,
      name: "Joseph Iwu",
      date: "6 weeks ago",
      text: '"Used engine sourced and fitted for my Evoque after unexpected engine failure. Delivery timescale was exactly as agreed and pricing was fair."',
      stars: 5,
    },
  ],
  overview: [
    {
      overviewHeading:
        "Reconditioned Range Rover Engines Supplied & Fitted For Norfolk",
      fullOverviewParagraphs: [
        "Norfolk drivers don't need a local Range Rover specialist nearby to get proper engine work done. We arrange collection from across the county, carry out the reconditioning or supply-and-fit work at our workshop, then return your vehicle running properly with the whole process managed from start to finish.",
        "Every reconditioned engine we supply is matched precisely to your model and fitted using genuine OEM parts. Drivers around Norwich and Great Yarmouth get the same specialist attention as customers who visit us directly, backed by clear delivery timescales and honest pricing throughout.",
      ],
    },
  ],
  technicalContent: [
  ...
  premiumServices: [
    {
      ...
      paragraphs: [
        "We source a reconditioned engine matched to your Range Rover's exact model, then arrange collection from Norfolk for fitting at our workshop.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Your vehicle is collected from Norfolk and returned once complete.",
      ],
  ...
  engineServicesMain: {
    heading: "Complete Engine & Drivetrain Support For Norfolk Owners",
    intro:
      "From timing components to a full engine replacement, we handle the essential work Range Rover and Land Rover engines actually need, with collection arranged from across Norfolk.",
    viewMoreHref: "/services",
  },
  specialistData: {
    heading: "Trusted Beyond Our Own Workshop Doors",
    paragraphs: [
      "Distance from our workshop shouldn't stand between Norfolk drivers and proper specialist engine work. We arrange collection and delivery so the process feels just as straightforward as booking locally, with the same manufacturer-approved procedures and genuine OEM parts used on every job. Clear timescales, transparent pricing, and honest communication mean you always know where your vehicle is in the process, whether it's still on collection or already back on the road.",
    ],
    mainBullets: [
      "Collection and delivery arranged across Norfolk",
    ...
    sidePanel: {
      ...
      bullets: [
        "Collection arranged directly from your Norfolk address",
