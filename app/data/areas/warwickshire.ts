...
export const warwickshireArea: Area = {
  id: "warwickshire",
  slug: "warwickshire",
  title: "Warwickshire",
  meta: {
  ...
  headerData: {
    ...
    highlights: [
      ...
      "Collection from Warwickshire, fitted at our workshop",
  ...
  reviews: [
    {
      id: 1,
      name: "Percival Ashdown",
      date: "3 weeks ago",
      text: '"Arranged collection from Warwick for a reconditioned engine on my Range Rover Evoque. Kept me updated at every stage and the fitted engine runs faultlessly."',
      stars: 5,
    },
    {
      id: 2,
      name: "Wilhelmina Croft",
      date: "1 month ago",
      text: '"Was unsure about the distance from Nuneaton, but collection was arranged quickly and the whole process felt easy to follow."',
      stars: 5,
    },
    {
      id: 3,
      name: "Rufus Blackthorn",
      date: "5 weeks ago",
      text: '"Booked engine diagnostics after my Sport started losing power on the M40. Diagnosis was accurate and the recommended repair matched exactly what it needed."',
      stars: 5,
    },
    {
      id: 4,
      name: "Adaora Chukwu",
      date: "2 months ago",
      text: '"Head gasket failure on my Vogue meant I needed a specialist that could collect from Warwickshire. Straightforward process with honest pricing throughout."',
      stars: 5,
    },
    {
      id: 5,
  ...
  overview: [
    {
      overviewHeading:
        "Reconditioned Range Rover Engines Supplied & Fitted For Warwickshire",
      fullOverviewParagraphs: [
        "Warwickshire drivers don't need a local Range Rover specialist nearby to get proper engine work done. We arrange collection from across the county, carry out the reconditioning or supply-and-fit work at our workshop, then return your vehicle running properly with the whole process managed from start to finish.",
        "Every reconditioned engine we supply is matched precisely to your model and fitted using genuine OEM parts. Drivers around Warwick and Nuneaton get the same specialist attention as customers who visit us directly, backed by clear delivery timescales and honest pricing throughout.",
      ],
    },
  ],
  technicalContent: [
  ...
  premiumServices: [
    {
      ...
      paragraphs: [
        "We source a reconditioned engine matched to your Range Rover's exact model, then arrange collection from Warwickshire for fitting at our workshop.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Your vehicle is collected from Warwickshire and returned once complete.",
      ],
  ...
  engineServicesMain: {
    heading: "Complete Engine & Drivetrain Support For Warwickshire Owners",
    intro:
      "From timing components to a full engine replacement, we handle the essential work Range Rover and Land Rover engines actually need, with collection arranged from across Warwickshire.",
    viewMoreHref: "/services",
  },
  specialistData: {
    heading: "Trusted Beyond Our Own Workshop Doors",
    paragraphs: [
      "Distance from our workshop shouldn't stand between Warwickshire drivers and proper specialist engine work. We arrange collection and delivery so the process feels just as straightforward as booking locally, with the same manufacturer-approved procedures and genuine OEM parts used on every job. Clear timescales, transparent pricing, and honest communication mean you always know where your vehicle is in the process, whether it's still on collection or already back on the road.",
    ],
    mainBullets: [
      "Collection and delivery arranged across Warwickshire",
    ...
    sidePanel: {
      ...
      bullets: [
        "Collection arranged directly from your Warwickshire address",
