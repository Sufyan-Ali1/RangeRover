...
export const lincolnshireArea: Area = {
  ...
  headerData: {
    ...
    highlights: [
      ...
      "Collection from Lincolnshire, fitted at our workshop",
  ...
  reviews: [
    {
      ...
      name: "Bertram Loxley",
      date: "3 weeks ago",
      text: '"Arranged collection from Lincoln for a reconditioned engine on my Range Rover Vogue. Kept me updated at every stage and the fitted engine runs beautifully."',
      stars: 5,
    },
    {
      id: 2,
      name: "Marigold Stanhope",
      date: "1 month ago",
      text: '"Was unsure about the distance from Grantham, but collection was arranged quickly and the whole process felt easy to follow."',
      stars: 5,
    },
    {
      id: 3,
      name: "Alaric Fenwick",
      date: "5 weeks ago",
      text: '"Booked engine diagnostics after my Sport started losing power on the A1. Diagnosis was accurate and the recommended repair matched exactly what it needed."',
      stars: 5,
    },
    {
      id: 4,
      name: "Temperance Dunmore",
      date: "2 months ago",
      text: '"Head gasket failure on my Evoque meant I needed a specialist that could collect from Lincolnshire. Straightforward process with honest pricing throughout."',
      stars: 5,
    },
    {
      id: 5,
  ...
  overview: [
    {
      overviewHeading:
        "Reconditioned Range Rover Engines Supplied & Fitted For Lincolnshire",
      fullOverviewParagraphs: [
        ...
        "Every reconditioned engine we supply is matched precisely to your model and fitted using genuine OEM parts. Drivers around Lincoln and Grantham get the same specialist attention as customers who visit us directly, backed by clear delivery timescales and honest pricing throughout.",
      ],
    },
  ],
  technicalContent: [
  ...
  premiumServices: [
    {
      ...
      paragraphs: [
        "We source a reconditioned engine matched to your Range Rover's exact model, then arrange collection from Lincolnshire for fitting at our workshop.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Your vehicle is collected from Lincolnshire and returned once complete.",
      ],
  ...
  engineServicesMain: {
    heading: "Complete Engine & Drivetrain Support For Lincolnshire Owners",
    intro:
      "From timing components to a full engine replacement, we handle the essential work Range Rover and Land Rover engines actually need, with collection arranged from across Lincolnshire.",
    viewMoreHref: "/services",
  },
  specialistData: {
    heading: "Trusted Beyond Our Own Workshop Doors",
    paragraphs: [
      "Distance from our workshop shouldn't stand between Lincolnshire drivers and proper specialist engine work. We arrange collection and delivery so the process feels just as straightforward as booking locally, with the same manufacturer-approved procedures and genuine OEM parts used on every job. Clear timescales, transparent pricing, and honest communication mean you always know where your vehicle is in the process, whether it's still on collection or already back on the road.",
    ],
    mainBullets: [
      "Collection and delivery arranged across Lincolnshire",
    ...
    sidePanel: {
      ...
      bullets: [
        "Collection arranged directly from your Lincolnshire address",
