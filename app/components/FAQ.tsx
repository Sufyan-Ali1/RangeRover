              ...
              {faqs.map((faq, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-[10px] border border-[#4CA66B] text-left transition-all duration-200 ${
                      isOpen ? "bg-[#ECFFF3]" : "bg-white hover:bg-[#F5FFF8]"
                    }`}
                  >
                    <div className="flex items-start gap-3 px-4 py-5 sm:gap-8 sm:px-8 sm:py-7">
